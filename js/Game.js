    ...
    if (allPlayers !== undefined) {
     ...
     //   d[allPlayers[plr].distance]=allPlayers[plr].name
      ...
      //  x = x + 200;
        ...
        text("Coins = "+allPlayers[plr].score, width-200, camera.position.y-200);
 ...
 //     d={};
  ...
  showLife() {
   ...
   // image(lifeImage, width / 2 - 130, height - player.positionY - 400, 20, 20);
    image(lifeImage, width / 2 - 130, camera.position.y-200 , 20, 20);
    fill("white");
    //rect(width / 2 - 100, height - player.positionY - 400, 185, 20);
    rect(width / 2 - 100, camera.position.y-200, 185, 20);
    fill("#f50057");
    //rect(width / 2 - 100, height - player.positionY - 400, player.life, 20);
    rect(width / 2 - 100, camera.position.y-200, player.life, 20);
    noStroke();
    pop();
  }
  ...
  showFuelBar() {
    ...
    image(fuelImage, width / 2 - 130, camera.position.y-150, 20, 20);
    fill("white");
    //rect(width / 2 - 100, height - player.positionY - 350, 185, 20);
    rect(width / 2 - 100, camera.position.y-150, 185, 20);
    fill("#ffc400");
    //rect(width / 2 - 100, height - player.positionY - 350, player.fuel, 20);
    rect(width / 2 - 100, camera.position.y-150, player.fuel, 20);
    noStroke();
    pop();
  }
